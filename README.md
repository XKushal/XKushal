...
```
╔══════════════════════════════════════════════════════════════╗
║  IDENTITY MODULE :: KUSHAL SINGH :: SECTOR 7G  ║  ONLINE ✦  ║
╚══════════════════════════════════════════════════════════════╝
```
...
[![Email](https://img.shields.io/badge/TRANSMIT-Email-FF4444?style=for-the-badge&logo=gmail&logoColor=white)](mailto:kushalsingh.business@gmail.com)
...
```
╔═══════════════════════════════════════════════╗
║  END OF PROFILE TRANSMISSION  ·  XKushal ⟁   ║
╚═══════════════════════════════════════════════╝
```

*"Complex problems. End-to-end ownership. Ship it."*
